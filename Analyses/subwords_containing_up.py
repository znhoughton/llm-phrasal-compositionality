...
+ up-within-word tokens) from random other tokens.
...
Usage:
    python subwords_containing_up.py [--model MODEL] [--data-dir DIR] [--vup-pkl PATH]
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Directory containing train/val/test CSVs and where layer outputs "
             "will be saved. Default: ../Data/olmo-3-7b/Data_upsubword",
    )
    parser.add_argument(
        "--vup-pkl",
